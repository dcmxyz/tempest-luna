<script lang="ts">
    ...
    const link = tv({
        base: "text-lg transition leading-none py-0.5 focus:outline-none focus:bg-ui-focus focus:text-ui-focus-text underline-offset-2 decoration-1 hover:underline-offset-4 hover:decoration-2 focus:decoration-3",
        variants: {
            variant: {
